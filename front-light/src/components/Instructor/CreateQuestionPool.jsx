...
const CreateQuestionPool = ({ subjectId, onQuestionPoolCreated }) => {
  ...
  return (
    <Box component="form" onSubmit={handleCreate} sx={{ mt: 2, p: 2, border: "1px solid #ccc", borderRadius: 2 }}>
      ...
      <TextField label={t("question_pool_name")} fullWidth margin="normal" value={name} onChange={(e) => setName(e.target.value)} required />
      <TextField label={t("description")} fullWidth margin="normal" value={description} onChange={(e) => setDescription(e.target.value)} />
